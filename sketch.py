...
\t./elf < in-""" + name + """.txt
\t@echo "\\n---------------------"
\t./elf < in-""" + name + """.txt > """ + name + """-OOOOOOUT.txt 
\tcolordiff -y """ + name + """-OOOOOOUT.txt true-""" + name + """.txt -W 100

small:
\t@echo "Making data.."
\t@-mv ~/Downloads/*-small-*.in ./
\t@cp ./*-small-*.in """ + name + """-IIIIIIIIIN.txt
   
large:
\t@echo "Making data.."
\t@-mv ~/Downloads/*-large-*.in ./
\t@cp ./*-large-*.in """ + name + """-IIIIIIIIIN.txt
