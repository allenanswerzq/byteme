# Ref: https://github.com/mkstayalive/CodeforcesSolutionDownloader
# Adapted to python3
...
dic = json.loads(urlopen(user_info_full_url).read())
if dic['status'] != u'OK':
...
for submission in submissions:
	try:
		...
		submission_info = urlopen(submission_full_url).read()
		...
		print('Catched an error, continue...')
		continue
end_time = time.time()
