// Depending on your application it's pretty unlikely that you'll have to type out the entirety of this struct. 
// For example, in most cases you won't need division, and you can leave out most of the operators too.
// NB: Thse are fairly terrible implementations. 
// Multiplication is about twice as slow as Python, 
// and division is about 20 times slower. 
// Use only as a last resort when for some reason you can't use Java's native bignums.
struct bignum {
